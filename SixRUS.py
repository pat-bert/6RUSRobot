...
class SixRUS(Robot):
    ...
    def __init__(self, stepper_mode=1 / 32, steps_per_rev=200, step_delay=0.0208):
        ...
        """
        super().__init__(dof=6, stepper_mode=stepper_mode, steps_per_rev=steps_per_rev, step_delay=step_delay,
                         rot_comp=np.array([1, -1] * 3))
    ...
    def inv_kinematic(self, pose: list):
        ...
        theta_1 = np.angle(((((z + dx * (s_ag - c_ag * s_b) + dy * (c_g * s_a + c_a * s_bg)) ** 2 - (
                    (z + dx * (s_ag - c_ag * s_b) + dy * (c_g * s_a + c_a * s_bg)) ** 2 + (
                        Dx - x - dx * c_bg + dy * c_b * s_g) ** 2 + (y - Dy + dx * (c_a * s_g + c_g * s_ab) + dy * (
                        c_ag - s_abg)) ** 2 + l1 ** 2 - l2 ** 2) ** 2 / (4 * l1 ** 2) + (
                                          Dx - x - dx * c_bg + dy * c_b * s_g) ** 2) * (
                                         z + dx * (s_ag - c_ag * s_b) + dy * (c_g * s_a + c_a * s_bg)) ** 2) ** (
                                        1 / 2) - ((Dx - x - dx * c_bg + dy * c_b * s_g) * (
                    (z + dx * (s_ag - c_ag * s_b) + dy * (c_g * s_a + c_a * s_bg)) ** 2 + (
                        Dx - x - dx * c_bg + dy * c_b * s_g) ** 2 + (y - Dy + dx * (c_a * s_g + c_g * s_ab) + dy * (
                        c_ag - s_abg)) ** 2 + l1 ** 2 - l2 ** 2)) / (2 * l1)) / (
                                       (z + dx * (s_ag - c_ag * s_b) + dy * (c_g * s_a + c_a * s_bg)) ** 2 + (
                                           Dx - x - dx * c_bg + dy * c_b * s_g) ** 2) - (((((z + dx * (
                    s_ag - c_ag * s_b) + dy * (c_g * s_a + c_a * s_bg)) ** 2 - ((z + dx * (s_ag - c_ag * s_b) + dy * (
                    c_g * s_a + c_a * s_bg)) ** 2 + (Dx - x - dx * c_bg + dy * c_b * s_g) ** 2 + (y - Dy + dx * (
                    c_a * s_g + c_g * s_ab) + dy * (c_ag - s_abg)) ** 2 + l1 ** 2 - l2 ** 2) ** 2 / (4 * l1 ** 2) + (
                                                                                                        Dx - x - dx * c_bg + dy * c_b * s_g) ** 2) * (
                                                                                                       z + dx * (
                                                                                                           s_ag - c_ag * s_b) + dy * (
                                                                                                                   c_g * s_a + c_a * s_bg)) ** 2) ** (
                                                                                                      1 / 2) * (
                                                                                                      Dx - x - dx * c_bg + dy * c_b * s_g) + (
                                                                                                      (z + dx * (
                                                                                                                  s_ag - c_ag * s_b) + dy * (
                                                                                                                   c_g * s_a + c_a * s_bg)) ** 2 * (
                                                                                                                  (
                                                                                                      ...
                                                                                                      2 * l1)) * j) / ((
                                                                                                                                   ...
                                                                                                                                   z + dx * (
                                                                                                                                       s_ag - c_ag * s_b) + dy * (
                                                                                                                                               c_g * s_a + c_a * s_bg))))
        theta_2 = np.angle(((((z + dx * (s_ag - c_ag * s_b) - dy * (c_g * s_a + c_a * s_bg)) ** 2 - (
                    (z + dx * (s_ag - c_ag * s_b) - dy * (c_g * s_a + c_a * s_bg)) ** 2 + (
                        Dy + y + dx * (c_a * s_g + c_g * s_ab) - dy * (c_ag - s_abg)) ** 2 + (
                                x - Dx + dx * c_bg + dy * c_b * s_g) ** 2 + l1 ** 2 - l2 ** 2) ** 2 / (4 * l1 ** 2) + (
                                          x - Dx + dx * c_bg + dy * c_b * s_g) ** 2) * (
                                         z + dx * (s_ag - c_ag * s_b) - dy * (c_g * s_a + c_a * s_bg)) ** 2) ** (
                                        1 / 2) + ((x - Dx + dx * c_bg + dy * c_b * s_g) * (
                    (z + dx * (s_ag - c_ag * s_b) - dy * (c_g * s_a + c_a * s_bg)) ** 2 + (
                        Dy + y + dx * (c_a * s_g + c_g * s_ab) - dy * (c_ag - s_abg)) ** 2 + (
                                x - Dx + dx * c_bg + dy * c_b * s_g) ** 2 + l1 ** 2 - l2 ** 2)) / (2 * l1)) / (
                                       (z + dx * (s_ag - c_ag * s_b) - dy * (c_g * s_a + c_a * s_bg)) ** 2 + (
                                           x - Dx + dx * c_bg + dy * c_b * s_g) ** 2) + (((((z + dx * (
                    s_ag - c_ag * s_b) - dy * (c_g * s_a + c_a * s_bg)) ** 2 - ((z + dx * (s_ag - c_ag * s_b) - dy * (
                    c_g * s_a + c_a * s_bg)) ** 2 + (Dy + y + dx * (c_a * s_g + c_g * s_ab) - dy * (
                    c_ag - s_abg)) ** 2 + (x - Dx + dx * c_bg + dy * c_b * s_g) ** 2 + l1 ** 2 - l2 ** 2) ** 2 / (
                                                                                                        4 * l1 ** 2) + (
                                                                                                        x - Dx + dx * c_bg + dy * c_b * s_g) ** 2) * (
                                                                                                       z + dx * (
                                                                                                           s_ag - c_ag * s_b) - dy * (
                                                                                                      ...
                                                                                                      (z + dx * (
                                                                                                                  ...
                                                                                                                  (
                                                                                                                              ...
                                                                                                                              Dy + y + dx * (
                                                                                                                                  c_a * s_g + c_g * s_ab) - dy * (
                                                                                                                                          c_ag - s_abg)) ** 2 + (
                                                                                                                              x - Dx + dx * c_bg + dy * c_b * s_g) ** 2 + l1 ** 2 - l2 ** 2)) / (
                                                                                                      2 * l1)) * j) / ((
                                                                                                                                   (
                                                                                                                                               z + dx * (
                                                                                                                                                   s_ag - c_ag * s_b) - dy * (
                                                                                                                                   ...
                                                                                                                                   z + dx * (
                                                                                                                                       s_ag - c_ag * s_b) - dy * (
                                                                                                                                               c_g * s_a + c_a * s_bg))))
        theta_3 = np.angle((2 * ((((2 * (c_g * s_a + c_a * s_bg) * (dy / 2 + (sqrt(3) * dx) / 2) - 2 * z + 2 * (
                    s_ag - c_ag * s_b) * (dx / 2 - (sqrt(3) * dy) / 2)) ** 2 - (((c_g * s_a + c_a * s_bg) * (
                    dy / 2 + (sqrt(3) * dx) / 2) - z + (s_ag - c_ag * s_b) * (dx / 2 - (sqrt(3) * dy) / 2)) ** 2 + (
                                                                                            Dx / 2 + x - (sqrt(
                                                                                        3) * Dy) / 2 - c_bg * (
                                                                                                        dx / 2 - (sqrt(
                                                                                                    3) * dy) / 2) + c_b * s_g * (
                                                                                            ...
                                                                                            Dy / 2 + y + (
                                                                                                sqrt(3) * Dx) / 2 - (
                                                                                                    ...
                                                                                                    3) * dy) / 2) - (
                                                                                                        c_ag - s_abg) * (
                                                                                                        dy / 2 + (sqrt(
                                                                                                    3) * dx) / 2)) ** 2 + l1 ** 2 - l2 ** 2) ** 2 / l1 ** 2 + (
                                               Dx / 2 + x - (sqrt(3) * Dy) / 2 + sqrt(3) * (
                                                   Dy / 2 + y + (sqrt(3) * Dx) / 2 - (c_a * s_g + c_g * s_ab) * (
                                                       dx / 2 - (sqrt(3) * dy) / 2) - (c_ag - s_abg) * (
                                                               dy / 2 + (sqrt(3) * dx) / 2)) - c_b * c_g * (
                                                           dx / 2 - (sqrt(3) * dy) / 2) + c_b * s_g * (
                                                           dy / 2 + (sqrt(3) * dx) / 2)) ** 2) * (
                                              2 * (c_g * s_a + c_a * s_bg) * (
                                                  dy / 2 + (sqrt(3) * dx) / 2) - 2 * z + 2 * (s_ag - c_ag * s_b) * (
                                                          dx / 2 - (sqrt(3) * dy) / 2)) ** 2) / 4) ** (1 / 2) - ((((
                                                                                                                               c_g * s_a + c_a * s_bg) * (
                                                                                                                               dy / 2 + (
                                                                                                                                   sqrt(
                                                                                                                                       3) * dx) / 2) - z + (
                                                                                                                         ...
                                                                                                                         3) * (
                                                                                                                                         ...
                                                                                                                                         dy / 2 + (
                                                                                                                                             sqrt(
                                                                                                                                                 3) * dx) / 2))) / l1) / (
                                       (2 * (c_g * s_a + c_a * s_bg) * (dy / 2 + (sqrt(3) * dx) / 2) - 2 * z + 2 * (
                                                   s_ag - c_ag * s_b) * (dx / 2 - (sqrt(3) * dy) / 2)) ** 2 + (
                                                   Dx / 2 + x - (sqrt(3) * Dy) / 2 + sqrt(3) * (
                                                       Dy / 2 + y + (sqrt(3) * Dx) / 2 - (c_a * s_g + c_g * s_ab) * (
                                                           dx / 2 - (sqrt(3) * dy) / 2) - (c_ag - s_abg) * (
                                                                   dy / 2 + (sqrt(3) * dx) / 2)) - c_b * c_g * (
                                                               dx / 2 - (sqrt(3) * dy) / 2) + c_b * s_g * (
                                                               dy / 2 + (sqrt(3) * dx) / 2)) ** 2) + ((2 * ((((2 * (
                    c_g * s_a + c_a * s_bg) * (dy / 2 + (sqrt(3) * dx) / 2) - 2 * z + 2 * (s_ag - c_ag * s_b) * (
                                                                                                                           dx / 2 - (
                                                                                                                               sqrt(
                                                                                                                                   3) * dy) / 2)) ** 2 - (
                                                                                                                          (
                                                                                                                                           ...
                                                                                                                                           Dy / 2 + y + (
                                                                                                                                               sqrt(
                                                                                                                                                   3) * Dx) / 2 - (
                                                                                                                                                       ...
                                                                                                                                                       dy / 2 + (
                                                                                                                                                           sqrt(
                                                                                                                                                               3) * dx) / 2)) ** 2 + l1 ** 2 - l2 ** 2)) / l1) * j) / (
                                       ((2 * (c_g * s_a + c_a * s_bg) * (dy / 2 + (sqrt(3) * dx) / 2) - 2 * z + 2 * (
                                                   s_ag - c_ag * s_b) * (dx / 2 - (sqrt(3) * dy) / 2)) ** 2 + (
                                                    Dx / 2 + x - (sqrt(3) * Dy) / 2 + sqrt(3) * (
                                                        Dy / 2 + y + (sqrt(3) * Dx) / 2 - (c_a * s_g + c_g * s_ab) * (
                                                            dx / 2 - (sqrt(3) * dy) / 2) - (c_ag - s_abg) * (
                                                                    dy / 2 + (sqrt(3) * dx) / 2)) - c_bg * (
                                                                dx / 2 - (sqrt(3) * dy) / 2) + c_b * s_g * (
                                                                dy / 2 + (sqrt(3) * dx) / 2)) ** 2) * (
                                                   2 * (c_g * s_a + c_a * s_bg) * (
                                                       dy / 2 + (sqrt(3) * dx) / 2) - 2 * z + 2 * (
                                                               s_ag - c_ag * s_b) * (dx / 2 - (sqrt(3) * dy) / 2))))
        theta_4 = np.angle((2 * ((((2 * z + 2 * (c_g * s_a + c_a * s_bg) * (dy / 2 - (sqrt(3) * dx) / 2) - 2 * (
                    s_ag - c_ag * s_b) * (dx / 2 + (sqrt(3) * dy) / 2)) ** 2 + (
                                               Dx / 2 + x + (sqrt(3) * Dy) / 2 + sqrt(3) * (
                                                   y - Dy / 2 + (sqrt(3) * Dx) / 2 - (c_a * s_g + c_g * s_ab) * (
                                                       dx / 2 + (sqrt(3) * dy) / 2) + (c_ag - s_abg) * (
                                                               dy / 2 - (sqrt(3) * dx) / 2)) - c_bg * (
                                                           dx / 2 + (sqrt(3) * dy) / 2) - c_b * s_g * (
                                                           dy / 2 - (sqrt(3) * dx) / 2)) ** 2 - ((Dx / 2 + x + (
                    sqrt(3) * Dy) / 2 - c_b * c_g * (dx / 2 + (sqrt(3) * dy) / 2) - c_b * s_g * (dy / 2 - (
                    sqrt(3) * dx) / 2)) ** 2 + (y - Dy / 2 + (sqrt(3) * Dx) / 2 - (c_a * s_g + c_g * s_ab) * (
                    dx / 2 + (sqrt(3) * dy) / 2) + (c_ag - s_abg) * (
                                                            dy / 2 - (sqrt(3) * dx) / 2)) ** 2 + l1 ** 2 - l2 ** 2 + (
                                                                                                             z + (
                                                                                                                 c_g * s_a + c_a * s_bg) * (
                                                                                                                         dy / 2 - (
                                                                                                                             sqrt(
                                                                                                                         ...
                                                                                                                         dx / 2 + (
                                                                                                                             sqrt(
                                                                                                                                 3) * dy) / 2)) ** 2) ** 2 / l1 ** 2) * (
                                              2 * z + 2 * (c_g * s_a + c_a * s_bg) * (
                                                  dy / 2 - (sqrt(3) * dx) / 2) - 2 * (s_ag - c_ag * s_b) * (
                                                          dx / 2 + (sqrt(3) * dy) / 2)) ** 2) / 4) ** (1 / 2) - (((
                                                                                                                              Dx / 2 + x + (
                                                                                                                                  sqrt(
                                                                                                                                      3) * Dy) / 2 - c_b * c_g * (
                                                                                                                         ...
                                                                                                                         3) * (
                                                                                                                                         ...
                                                                                                                                         dy / 2 - (
                                                                                                                                             sqrt(
                                                                                                                                                 3) * dx) / 2))) / l1) / (
                                       (2 * z + 2 * (c_g * s_a + c_a * s_bg) * (dy / 2 - (sqrt(3) * dx) / 2) - 2 * (
                                                   s_ag - c_ag * s_b) * (dx / 2 + (sqrt(3) * dy) / 2)) ** 2 + (
                                                   Dx / 2 + x + (sqrt(3) * Dy) / 2 + sqrt(3) * (
                                                       y - Dy / 2 + (sqrt(3) * Dx) / 2 - (c_a * s_g + c_g * s_ab) * (
                                                           dx / 2 + (sqrt(3) * dy) / 2) + (c_ag - s_abg) * (
                                       ...
                                       ((2 * z + 2 * (c_g * s_a + c_a * s_bg) * (dy / 2 - (sqrt(3) * dx) / 2) - 2 * (
                                                   ...
                                                   2 * z + 2 * (c_g * s_a + c_a * s_bg) * (
                                                       dy / 2 - (sqrt(3) * dx) / 2) - 2 * (s_ag - c_ag * s_b) * (
                                                               dx / 2 + (sqrt(3) * dy) / 2))))
        theta_5 = np.angle((2 * ((((2 * (c_g * s_a + c_a * s_bg) * (dy / 2 - (sqrt(3) * dx) / 2) - 2 * z + 2 * (
                    s_ag - c_ag * s_b) * (dx / 2 + (sqrt(3) * dy) / 2)) ** 2 - (((c_g * s_a + c_a * s_bg) * (
                    dy / 2 - (sqrt(3) * dx) / 2) - z + (s_ag - c_ag * s_b) * (dx / 2 + (sqrt(3) * dy) / 2)) ** 2 + (
                                                                                            Dx / 2 + x + (sqrt(
                                                                                        3) * Dy) / 2 - c_bg * (
                                                                                            ...
                                                                                            (sqrt(
                                                                                                3) * Dx) / 2 - y - Dy / 2 + (
                                                                                                    ...
                                                                                                    3) * dx) / 2)) ** 2) ** 2 / l1 ** 2 + (
                                               Dx / 2 + x + (sqrt(3) * Dy) / 2 + sqrt(3) * (
                                                   (sqrt(3) * Dx) / 2 - y - Dy / 2 + (c_a * s_g + c_g * s_ab) * (
                                                       dx / 2 + (sqrt(3) * dy) / 2) + (c_ag - s_abg) * (
                                                               dy / 2 - (sqrt(3) * dx) / 2)) - c_b * c_g * (
                                                           dx / 2 + (sqrt(3) * dy) / 2) + c_b * s_g * (
                                                           dy / 2 - (sqrt(3) * dx) / 2)) ** 2) * (
                    ...
                    c_g * s_a + c_a * s_bg) * (dy / 2 - (sqrt(3) * dx) / 2) - 2 * z + 2 * (s_ag - c_ag * s_b) * (
                                       ...
                                       ((2 * (c_g * s_a + c_a * s_bg) * (dy / 2 - (sqrt(3) * dx) / 2) - 2 * z + 2 * (
                                                   ...
                                                   2 * (c_g * s_a + c_a * s_bg) * (
                                                       dy / 2 - (sqrt(3) * dx) / 2) - 2 * z + 2 * (
                                                               s_ag - c_ag * s_b) * (dx / 2 + (sqrt(3) * dy) / 2))))
        theta_6 = np.angle((2 * ((((2 * z + 2 * (c_g * s_a + c_a * s_bg) * (dy / 2 + (sqrt(3) * dx) / 2) - 2 * (
                    s_ag - c_ag * s_b) * (dx / 2 - (sqrt(3) * dy) / 2)) ** 2 - (((sqrt(
            3) * Dy) / 2 - x - Dx / 2 + c_bg * (dx / 2 - (sqrt(3) * dy) / 2) + c_b * s_g * (dy / 2 + (
                    sqrt(3) * dx) / 2)) ** 2 + l1 ** 2 - l2 ** 2 + (z + (c_g * s_a + c_a * s_bg) * (
                    dy / 2 + (sqrt(3) * dx) / 2) - (s_ag - c_ag * s_b) * (dx / 2 - (sqrt(3) * dy) / 2)) ** 2 + (
                                                                                            Dy / 2 - y + (
                                                                                                sqrt(3) * Dx) / 2 + (
                                                                                                        c_a * s_g + c_g * s_ab) * (
                                                                                                        dx / 2 - (sqrt(
